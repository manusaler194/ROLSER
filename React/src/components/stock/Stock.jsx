                        ...
                        <div key={articulo.id_articulo} className="bg-white p-6 rounded-3xl border border-gray-200 shadow-sm transition-active active:scale-[0.98]">
                            <div className="flex justify-between items-start mb-4">
                                ...
                                <div>
                                    {articulo.stock_actual < 50 ? (
                                        ...
                                        <span className={`px-3 py-1 text-[10px] font-black rounded-full uppercase ${articulo.stock_actual < 100 ? 'bg-orange-100 text-orange-600' : 'bg-green-100 text-green-600'}`}>
                            ...
                            <div className="flex justify-between items-center pt-4 border-t border-gray-50">
                                <div className="flex flex-col">
                                    ...
                                    <span className={`text-2xl font-black ${articulo.stock_actual < 50 ? 'text-red-600' : articulo.stock_actual < 100 ? 'text-orange-500' : 'text-green-600'}`}>
                                        {articulo.stock_actual}
                                    </span>
                                </div>
                                <div className={`w-4 h-4 rounded-full ${articulo.stock_actual < 50 ? 'bg-red-500 shadow-[0_0_12px_rgba(239,68,68,0.6)]' : articulo.stock_actual < 100 ? 'bg-orange-400' : 'bg-green-500'}`}></div>
                            </div>
                        </div>
                    ))}
                </div>
