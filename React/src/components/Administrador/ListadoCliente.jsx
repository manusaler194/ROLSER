...
const ListadoCliente = () => {
  ...
  const clientesVisibles = filtrados.slice(indicePrimerItem, indiceUltimoItem);
...
const ListadoCliente = () => {
  ...
  return (
    // Reducido el padding en móviles (p-4) y restaurado en desktop (md:p-8)
    <div className="min-h-screen bg-gray-100 p-4 md:p-8 font-sans">
      <div className="max-w-4xl mx-auto">
        ...
        {/* CABECERA */}
        {/* Cambiado a flex-col en móviles para que no se aplaste */}
        <div className="flex flex-col sm:flex-row sm:justify-between sm:items-center gap-4 mb-6 md:mb-8">
          <div>
            <h2 className="text-2xl md:text-3xl font-bold uppercase text-gray-900">Clientes</h2>
        ...
        <div className="bg-white rounded-xl border border-gray-200 shadow-lg overflow-hidden">
          {clientesVisibles.length > 0 ? (
            clientesVisibles.map((cliente) => (
              <div 
                key={cliente.id_cliente} 
                // Adaptado a flex-col en móviles con un poco de gap
              ...
              >
                <div className="w-full sm:w-auto overflow-hidden">
                  ...
                  {/* break-words evita que los emails muy largos rompan el diseño en móviles */}
                  <span className="text-xs md:text-sm text-gray-500 break-words">{cliente.email}</span>
                  {cliente.comercial && (
                    <span className="block text-xs text-gray-400 mt-1">
                      Comercial: {cliente.comercial.nombre}
                    </span>
                ...
                {/* Botones: flex-wrap para que se acomoden bien si la pantalla es muy pequeña */}
