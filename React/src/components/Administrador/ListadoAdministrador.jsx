            ...
            administradoresVisibles.map((admin) => (
              ...
              >
                <div className="break-all">
                  <span className="block text-base sm:text-lg font-bold text-gray-800">
                    {admin.nombre} {admin.apellidos}
                  </span>
                  <span className="text-sm text-gray-500">{admin.email}</span>
                </div>
                ...
                <div className="flex flex-wrap gap-2">
                  <button
                    onClick={() => navigate(`/modificar-admin/${admin.id_administrador}`)}
                    className="flex-1 sm:flex-none bg-black text-white px-4 py-2 rounded-full text-xs font-bold hover:bg-gray-800 transition-all shadow-sm uppercase tracking-wider text-center"
                  >
                    Modificar
                  </button>
                  ...
                  <button
                    onClick={() => eliminarAdmin(admin.id_administrador)}
                    className="flex-1 sm:flex-none bg-red-600 text-white px-4 py-2 rounded-full text-xs font-bold hover:bg-red-800 transition-all shadow-sm uppercase tracking-wider text-center"
                  >
                    Borrar
                  </button>
                  ...
                  <button
                    onClick={() => setAdminSeleccionado(admin)}
                    className="flex-1 sm:flex-none w-full sm:w-auto bg-white border border-[#bd0026] text-[#bd0026] px-4 py-2 rounded-full text-xs font-bold hover:bg-[#bd0026] hover:text-white transition-all shadow-sm uppercase tracking-wider text-center mt-2 sm:mt-0"
                  >
                    Ver Ficha
                  </button>
                </div>
