...
const ModificarClienteVip = () => {
        ...
        const cargarClienteVip = async () => {
            try {
                ...
                setClienteVip({
                    ...
                    // Mapeo flexible por si en BD es 'email' o 'correo'
    ...
    if (estaCargando) {
        return <div className="flex h-screen justify-center items-center">Cargando datos del Cliente VIP...</div>;
    }
        ...
        <div className="flex justify-center items-center min-h-screen bg-gray-50 font-sans">
            <div className="w-full max-w-2xl p-10 bg-white border border-gray-200 rounded-[2rem] shadow-lg">
                ...
                <form onSubmit={manejarEnvio}>
                    <label className="ml-4 mb-1 block text-xs font-bold text-gray-500 uppercase">Nombre / Razón Social</label>
                    <input 
                        type="text" 
                        name="nombre" 
