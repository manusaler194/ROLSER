                ...
                <table className="w-full text-left border-collapse">
                    ...
                    <tbody className="divide-y divide-gray-100">
                        {pedidosFiltrados.length > 0 ? (
                            ...
                            <tr><td colSpan="4" className="text-center py-10 text-gray-400 italic">No tienes pedidos que coincidan</td></tr>
                        )}
                    </tbody>
                </table>
            </div>
                ...
                {pedidosFiltrados.map((pedido) => (
                    <div key={pedido.id_pedido} className="bg-white p-5 rounded-2xl border border-gray-200 shadow-sm relative">
                        ...
                        <div className="flex justify-between items-end mt-4 pt-4 border-t border-gray-50">
                            ...
                            <Link 
                                to={`/DetallesPedido/cliente/${pedido.id_pedido}`} 
...
export default GestionarPedidosCliente;