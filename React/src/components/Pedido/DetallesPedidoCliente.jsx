  ...
  if (!pedido) {
    return (
      <div className="flex justify-center items-center min-h-screen">
        <div className="animate-spin rounded-full h-10 w-10 border-t-2 border-b-2 border-[#bc002d]"></div>
      </div>
    );
  }
  ...
  return (
    <div className="flex justify-center items-center min-h-screen bg-gray-50 p-4 sm:py-10">
      <div className="w-full max-w-3xl p-6 sm:p-10 bg-white border border-gray-200 rounded-4xl shadow-lg">
        ...
        <div className="mb-8">
          <label className="block ml-4 mb-1 text-sm font-bold text-gray-600">Comercial asignado</label>
          <div className={`${inputClasses} flex items-center gap-3 bg-red-50 border-red-200`}>
            <span className="font-medium">
              {pedido.comercial?.nombre || "Pedido realizado online / Sin comercial"}
            </span>
          </div>
        </div>

        <div className="mb-8">
          <h3 className="text-xl font-bold text-gray-700 mb-4 ml-2 flex items-center gap-2">
            <span className="w-1.5 h-5 bg-[#bc002d] rounded-full"></span>
