...
const GestionarPedidosClientevip = () => {
    ...
    const obtenerPedidos = async () => {
        try {
            ...
            const misPedidos = data.pedidos.filter(p => 
                p.id_clientevip === user.id_clientevip
            );
                            ...
                            pedidosFiltrados.map((pedido) => (
                                <tr key={pedido.id_pedido} className="hover:bg-gray-50 transition-colors">
                                    ...
                                    <td className="px-6 py-4 text-right">
                                        <Link 
                                            to={`/DetallesPedido/clientevip/${pedido.id_pedido}`} 
...
export default GestionarPedidosClientevip;